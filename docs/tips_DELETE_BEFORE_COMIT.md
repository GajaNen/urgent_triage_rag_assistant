...
Add a short app preview video if it helps. If you're using Streamlit, you can record it from the app's top-right menu (Streamlit Guide). Then drag and drop the video into the online GitHub editor of your README (Ref).
...
If you use a tool that wasn't covered in the course, explain what that tool does. Also explain how to use it.
